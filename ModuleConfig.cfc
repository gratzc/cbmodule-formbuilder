...
component {
	...
	function configure(){
		...
		//Mappings
		binder.map("TypeService@cbFormBuilder").to("#moduleMapping#.models.TypeService");
		binder.map("FormSubmissionService@cbFormBuilder").to("#moduleMapping#.models.FormSubmissionService");
